<template>
  <div class="bg-teal antialiased">
    ...
    <main class="px-3 py-6 space-y-2">
      ...
      <div>
        <div class="mt-6" v-for="i in 5" :key="i">
          <div class="relative pb-2/3 rounded-lg shadow-md">
            <img
              class="absolute h-full w-full object-cover rounded-lg shadow-md"
              src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80"
              alt="house"
            />
          </div>
